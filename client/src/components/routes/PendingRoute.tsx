...
import {createAssociatedTokenAccount, getAssociatedTokenAddress, TOKEN_PROGRAM_ID,ASSOCIATED_TOKEN_PROGRAM_ID} from "@solana/spl-token"
...
export const PendingRoute: FC = () => {
    ...
    async function getOrCreateAssociatedTokenAccount(
        ...
        if (await connection.getAccountInfo(associatedTokenAddress)) {
            ...
            const associatedToken = await getAssociatedTokenAddress(mint, publicKey, false, TOKEN_PROGRAM_ID, ASSOCIATED_TOKEN_PROGRAM_ID);
    ...
    const transferOverContract =  async function (){
        ...
        const merchantTokenPubkey = await getOrCreateAssociatedTokenAccount(connection,customTokenAddress,new PublicKey(merchantAddress));
